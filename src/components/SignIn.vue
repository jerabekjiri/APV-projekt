<template>
  ...
  <md-card>
    ...
    <md-card-actions>
      <md-button type="submit" class="md-primary" @click="signIn()" :disabled="!isAllFilled">Sign In</md-button>
  </md-card-actions>
...
<md-snackbar md-position="center" :md-active="isError" md-persistent :md-duration="5000">

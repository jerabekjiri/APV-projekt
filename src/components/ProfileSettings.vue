  ...
  <div class="md-layout">
    ...
    <div class="md-layout-item  md-size-30">
      <md-card class="avatar">
          <md-card-content>
           <img :src="user.avatar"  @click="uploadDialog = true">
        </md-card-content>
     </md-card>
    </div>
    ...
    <md-dialog :md-active.sync="uploadDialog">
     <md-dialog-title>Upload new avatar</md-dialog-title>
       <md-dialog-content>
          <md-field>
            <label>Avatar</label>
     ...
     <md-dialog-actions>
       <md-button class="md-primary" @click="uploadDialog = false">Close</md-button>
       <md-button class="md-primary" @click="upload()" :disabled="!image">Upload</md-button>
     </md-dialog-actions>
   </md-dialog>
